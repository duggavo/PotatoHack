	...
	implements GUIRenderListener, UpdateListener
{
	private final Identifier[] tacos =
		{new Identifier("potato", "dancingtaco1.png"),
			new Identifier("potato", "dancingtaco2.png"),
			new Identifier("potato", "dancingtaco3.png"),
			new Identifier("potato", "dancingtaco4.png")};
