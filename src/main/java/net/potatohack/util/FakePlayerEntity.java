...
{
	private final ClientPlayerEntity player = PotatoHack.MC.player;
	private final ClientWorld world = PotatoHack.MC.world;
	
	public FakePlayerEntity()
	{
		super(PotatoHack.MC.world, PotatoHack.MC.player.getGameProfile());
