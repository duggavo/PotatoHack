...
public final class KeybindProfilesScreen extends Screen
{
	...
	public void init()
	{
		listGui = new ListGui(client, this,
			PotatoHack.INSTANCE.getKeybinds().listProfiles());
	...
	private void openFolder()
	{
		Util.getOperatingSystem().open(
			PotatoHack.INSTANCE.getKeybinds().getProfilesFolder().toFile());
	}
	...
	private void newProfile(String name)
	{
		...
		try
		{
			PotatoHack.INSTANCE.getKeybinds().saveProfile(name);
	...
	private void loadSelected()
	{
		...
		try
		{
			PotatoHack.INSTANCE.getKeybinds().loadProfile(fileName);
			openPrevScreen();
