 ...
 */
package net.potatohack.altmanager.screens;
...
import net.potatohack.altmanager.*;
import net.potatohack.mixinterface.IScreen;
import net.potatohack.util.ListWidget;
import net.potatohack.util.MultiProcessingUtils;
...
public final class AltManagerScreen extends Screen
{
	...
	private void pressImportAlts()
	{
		try
		{
			Process process = MultiProcessingUtils.startProcessWithIO(
				...
				PotatoHack.INSTANCE.getWurstFolder().toString());
	...
	{
		// translate
		String translated = PotatoHack.INSTANCE
