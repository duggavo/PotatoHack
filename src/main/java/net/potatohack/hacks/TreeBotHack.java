...
import net.potatohack.ai.PathFinder;
import net.potatohack.ai.PathPos;
import net.potatohack.ai.PathProcessor;
import net.potatohack.commands.PathCmd;
...
import net.potatohack.treebot.Tree;
import net.potatohack.treebot.TreeBotUtils;
	...
	implements UpdateListener, RenderListener
{
	...
	private class TreeFinder extends TreeBotPathFinder
	{
		public TreeFinder()
		{
			super(BlockPos.ofFloored(PotatoHack.MC.player.getPos()));
		}
