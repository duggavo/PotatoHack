...
import net.potatohack.hacks.autolibrarian.BookOffer;
import net.potatohack.hacks.autolibrarian.FacingSetting;
import net.potatohack.hacks.autolibrarian.SwingHandSetting;
import net.potatohack.hacks.autolibrarian.UpdateBooksSetting;
import net.potatohack.mixinterface.IKeyBinding;
import net.potatohack.settings.BookOffersSetting;
...
import net.potatohack.util.*;
import net.potatohack.util.BlockBreaker.BlockBreakingParams;
import net.potatohack.util.BlockPlacer.BlockPlacingParams;
