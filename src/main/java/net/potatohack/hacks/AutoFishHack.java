...
import net.potatohack.hacks.autofish.AutoFishDebugDraw;
import net.potatohack.hacks.autofish.AutoFishRodSelector;
import net.potatohack.hacks.autofish.ShallowWaterWarningCheckbox;
