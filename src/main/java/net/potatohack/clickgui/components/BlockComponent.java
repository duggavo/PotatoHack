...
import net.potatohack.clickgui.screens.EditBlockScreen;
import net.potatohack.settings.BlockSetting;
...
public final class BlockComponent extends Component
{
	...
	public void handleMouseClick(double mouseX, double mouseY, int mouseButton)
	{
		...
		if(mouseButton == 0)
		{
			Screen currentScreen = PotatoHack.MC.currentScreen;
			EditBlockScreen editScreen =
				new EditBlockScreen(currentScreen, setting);
			PotatoHack.MC.setScreen(editScreen);
