...
import net.potatohack.clickgui.screens.SelectFileScreen;
...
public final class FileComponent extends Component
{
	...
	public void handleMouseClick(double mouseX, double mouseY, int mouseButton)
	{
		...
		TextRenderer fr = PotatoHack.MC.textRenderer;
		int buttonWidth = fr.getWidth(setting.getSelectedFileName());
		
		if(mouseX < getX() + getWidth() - buttonWidth - 4)
			return;
		
		PotatoHack.MC.setScreen(
			new SelectFileScreen(PotatoHack.MC.currentScreen, setting));
	}
