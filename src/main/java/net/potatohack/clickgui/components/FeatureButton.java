 ...
 */
package net.potatohack.clickgui.components;
...
import net.potatohack.clickgui.SettingsWindow;
...
{
	private final MinecraftClient MC = PotatoHack.MC;
	private final ClickGui GUI = PotatoHack.INSTANCE.getGui();
