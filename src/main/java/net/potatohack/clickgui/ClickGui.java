 ...
 */
package net.potatohack.clickgui;
...
import net.potatohack.clickgui.components.FeatureButton;
import net.potatohack.hacks.ClickGuiHack;
...
{
	private static final PotatoHack WURST = PotatoHack.INSTANCE;
	...
	public void init()
	{
		...
		windows.add(PotatoHack.INSTANCE.getHax().radarHack.getWindow());
